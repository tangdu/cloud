 ...
 *
 * @author tangdu
 * @version $: JwtUtil.java, v 0.1 2018年07月03日 下午5:00 tangdu Exp $
 */
@Slf4j
public class JwtUtil {
     ...
     * JWT 生成密钥使用的密码
     */
    private static final String JWT_RULE = "fuck.you";
    ...
    private static final int DEFAULT_EXPIRED_DATE=1800;
    ...
    public static SecretKey generateKey(SignatureAlgorithm alg, String rule) {
        // 根据指定的加密方式，生成密钥
        return new SecretKeySpec(rule.getBytes(), alg.getJcaName());
    }
    ...
    public static String buildJWT(String sub) {
        return buildJWT(sub, null, UUID.randomUUID().toString(), null, null, DEFAULT_EXPIRED_DATE);
    }
